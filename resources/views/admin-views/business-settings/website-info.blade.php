    ...
    <div class="content container-fluid">
        ...
        <div
            ...
            <form action="{{ route('admin.business-settings.update-info') }}" method="POST"
              ...
              <div class="row" style="padding-bottom: 20px">
                    <div class="col-md-4">
                        @php($companyAddress=\App\Model\BusinessSetting::where('type','company_address')->first())
                        <div class="form-group">
                            <label
                                class="input-label">{{\App\CPU\translate('company')}} {{\App\CPU\translate('address')}}</label>
                            <input class="form-control" type="text" name="company_address"
                                   value="{{ $companyAddress->value?$companyAddress->value:" " }}"
                                   placeholder="New Business">
                        </div>
                    </div>
                   <div class="col-md-4">
                        @php($slink=\App\Model\BusinessSetting::where('type','slink')->first())
                        <div class="form-group">
                            <label
                                class="input-label">{{\App\CPU\translate('syriatel')}} {{\App\CPU\translate('link')}}</label>
                            <input class="form-control" type="text" name="slink"
                                   value="{{ $slink->value?$slink->value:" " }}"
                                   placeholder="New Business">
                        </div>
                    </div>
                    <div class="col-md-4">
                        @php($facebook_link=\App\Model\BusinessSetting::where('type','facebook_link')->first())
                        <div class="form-group">
                            <label class="input-label">{{\App\CPU\translate('facebook link')}}</label>
                            <input class="form-control" type="text" name="facebook_link"
                                   value="{{ $facebook_link->value?$facebook_link->value:"" }}"
                                   placeholder="New Business">
                        </div>
                    </div>
                </div>
