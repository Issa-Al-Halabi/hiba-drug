...
<div class="content container-fluid">
    ...
    <div class="row gx-2 gx-lg-3">
        <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.reward-item.updateProduct',[$rewardItemall['id']])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <input style="visibility: hidden;" type="text" value="{{$rewardItemall['id']}}" name="id" class="form-control" placeholder="New sales-man">
                            <input style="visibility: hidden;" type="text" value="{{$rewardItemall['product_id']}}" name="product_id" class="form-control" placeholder="New sales-man">
