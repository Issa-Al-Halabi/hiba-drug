                    ...
                    <div class="card-header">
                        <div class="row" style="width: 100%">
                            ...
                            <div class="col-12 col-md-8 text-right">
                                <a href="{{route('admin.reward-item.addProduct')}}" class="btn btn-primary pull-right"><i
                    ...
                    <div class="table-responsive datatable-custom">
                        <table
                            ...
                            <tr>
                                ...
                                <th>{{\App\CPU\translate('name')}} {{\App\CPU\translate('product')}}</th>
                                <th></th>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   href="{{route('admin.reward-item.showUpdateProduct', [$item['id']])}}">{{\App\CPU\translate('edit')}}</a>
                                                <a class="dropdown-item" href="javascript:"
                                                   onclick="form_alert('sales-man-{{$item['id']}}','Want to remove this information ?')">{{\App\CPU\translate('delete')}}</a>
                                                <form action="{{route('admin.reward-item.destroyProduct', [$item['id']])}}"
