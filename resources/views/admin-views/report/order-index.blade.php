            ...
            <div class="card h-100">
                ...
                <div class="card-header">
                  ...
                  @php
                    ...
                    @endphp
                   <a  style="margin-top:0px;width: fit-content;" class="btn btn-success btn-block mx-2" target="_blank"
                            href={{ route('admin.orders.generate-excel-all',["from" => "$startOfWeek","to" => "$endOfWeek"])}}>
                     <i class="tio-print mr-1"></i> {{ \App\CPU\translate('Export') }}</a>
