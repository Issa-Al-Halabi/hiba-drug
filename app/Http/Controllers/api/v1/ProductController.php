...
class ProductController extends Controller
{
    ...
    {
        $products = ProductManager::get_latest_products($request['brand_id'],$request['limit'], $request['offset']);
    ...
    {
        $products = ProductManager::get_featured_products($request['brand_id'],$request['limit'], $request['offset']);
        $products['products'] = Helpers::product_data_formatting($products['products'], true);
        return response()->json($products, 200);
    }
    ...
    {
        $products = ProductManager::get_top_rated_products($request['brand_id'],$request['limit'], $request['offset']);
        $products['products'] = Helpers::product_data_formatting($products['products'], true);
        return response()->json($products, 200);
    }
    ...
    {
        $products = ProductManager::get_best_selling_products($request['brand_id'],$request['limit'], $request['offset']);
        $products['products'] = Helpers::product_data_formatting($products['products'], true);
        return response()->json($products, 200);
    }
